                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                    <div class="form-check">
                                        <input type="radio" name="role_id" value="2" @if(isset($role_id)&& $role_id==2) checked @endif >
                                        <label for="">  Donor </label>

                                        <input type="radio" name="role_id" value="3" @if(isset($role_id)&& $role_id==3) checked @endif>
                                        <label for="">Organization</label>

                                        <input type="radio" name="role_id" value="4" @if(isset($role_id)&& $role_id==4) checked @endif>
                                        <label for="">Volunteer</label>

                                        <input type="radio" name="role_id" value="5" @if(isset($role_id)&& $role_id==5) checked @endif>
                                        <label for="">Help Seeker</label>
                                    </div>
